...
from utils import database, output
...
async def on_server_join(server):
    """Adds a table given a server for user tracking to the database"""
...
async def on_server_leave(server):
    """Removes a table given a server from the database"""
    database.remove_server(server)
